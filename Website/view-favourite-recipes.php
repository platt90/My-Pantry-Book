        ...
        <div id="main_body">
            <div id="advert_recipes">
                <div class="recipes">
                    ...
                    if ($res = $mysqli->query('SELECT recipe_id, name, image FROM recipe INNER JOIN favourite USING (recipe_id) WHERE iduser = ' . $_COOKIE["idUser"] . '')) {
                        echo "<h1>Favourite Recipes</h1>\n";
                        if ($res->data_seek(0)) {
                            ...
                            echo "<br>You Have No Saved Recipes";
                        }
                    } else {
